 ...
 * 			  호출 스택은 제일 상위에 있는 메소드가 지금 실행되고 있는 메소드 입니다.
 * 			  나머지는 모두 대기합니다.
 * 			  -> 언제나 호출 스텍 제일 위에 있는 메소드가 실행중인 메소드 입니다.
...
public class Memory { //스택 구조(후입선출) > 맨 마지막에 시작한게 끝날때는 제일 처음 끝난다.
